		...
		<div class="info-box bg-aqua">
			...
			<div class="info-box-content">
				...
				<span class="progress-description">
					Patient Code1: {{$patient->patientcode}}
				</span>
			</div>
			<!-- /.info-box-content -->
		</div>
...
<script>
	Dropzone.options.addImages = {
		dictDefaultMessage: "Drop or Click here to upload Scanned Report Images - Only jpeg, png and gif images allowed (max size 4 MB)",
